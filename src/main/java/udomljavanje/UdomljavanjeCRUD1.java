...
// * @version 1.2
// */
//public class UdomljavanjeCRUD1 extends korisni.Kontroler {
...
//     */
//    public UdomljavanjeCRUD1() throws SQLException {
//        createTable();       
//    }
//
//    /**
...
//        String sql = "SELECT * FROM udomljavanje " +
//                     "WHERE idKlijenti = ? AND idLjubimac = ? " +
//                     "AND status = ? " +
//                     "ORDER BY datumUdomljavanja DESC " +
//                     "LIMIT 1";  // Samo najnovija
//
//        try (Connection kon = getKone(); 
//             PreparedStatement pstmt = kon.prepareStatement(sql)) {
//
...
//                    u.setLjub(lk.dobaviLjubimcaPoId(u.getIdLjubimac()));
//                    return u;
//                    // Provjera da li je rezervacija istekla
////                    if (!jeRezervacijaIstekla(u.getDatumUdomljavanja())) {
////                        
////                    }
//                }
//            }
